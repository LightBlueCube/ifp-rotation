...
// ifp modify
global function AddCallback_SetCustomPostMatchLength
...
struct {
	...
	// ifp modify
	void functionref() setCustomPostMatchLengthCallbacks
	// northstar new adding callbacks
...
void function GameStateEnter_Postmatch_Threaded()
{
	...
	if( file.setCustomPostMatchLengthCallbacks != null )
		file.setCustomPostMatchLengthCallbacks()
	else
...
// ifp modify
void function AddCallback_SetCustomPostMatchLength( void functionref() callback )
{
	file.setCustomPostMatchLengthCallbacks = callback
}
